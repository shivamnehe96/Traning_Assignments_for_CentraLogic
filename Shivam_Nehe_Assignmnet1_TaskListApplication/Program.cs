...
namespace TaskList_Application
{
    internal class Program
    {
        ...
        static void UpdateTask()
        {
            ...
            Console.WriteLine("3. Both Title and Description");
            Console.Write("Enter your choice: ");
            int choice = Convert.ToInt32(Console.ReadLine());

            string newTitleForTask = tasks[taskNumber].Item1;
            string newDescriptionForTask = tasks[taskNumber].Item2;

            switch (choice)
            {
                case 1:
                    Console.Write("Enter new title to update: ");
                    newTitleForTask = Console.ReadLine();
                    break;
                case 2:
                    Console.Write("Enter new task description: ");
                    newDescriptionForTask = Console.ReadLine();
                    break;
                case 3:
                    Console.Write("Enter new title to update: ");
                    newTitleForTask = Console.ReadLine();
